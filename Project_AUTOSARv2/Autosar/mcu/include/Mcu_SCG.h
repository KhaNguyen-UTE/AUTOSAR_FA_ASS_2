...
#define MCU_SCG_SW_PATCH_VERSION             4
...
#if (STD_ON == MCU_ENABLE_USER_MODE_SUPPORT)
/** @violates @ref Mcu_SCG_h_REF_3 Function-like macro defined.*/
#define  Call_Mcu_SCG_DropSystemClockToTrustedClock() \
do\
{ \
        Mcal_Trusted_Call(Mcu_SCG_DropSystemClockToTrustedClock); \
}\
while(0)
#else
/** @violates @ref Mcu_SCG_h_REF_3 Function-like macro defined.*/
...
/***********************************created by HaoTV13********************************************/
#define  Call_Mcu_SCG_ActivePllClock() \
do\
{ \
        Mcu_SCG_ActivePllClock(); \
}\
while(0)
/***********************************created by HaoTV13********************************************/
...
#if (STD_ON == MCU_ENABLE_USER_MODE_SUPPORT)
/** @violates @ref Mcu_SCG_h_REF_3 Function-like macro defined.*/
#define  Call_Mcu_SCG_PrepareSpllBeforeSoscInit() \
do\
{ \
        Mcal_Trusted_Call(Mcu_SCG_PrepareSpllBeforeSoscInit); \
}\
while(0)
#else
/** @violates @ref Mcu_SCG_h_REF_3 Function-like macro defined.*/
...
#if (STD_ON == MCU_ENABLE_USER_MODE_SUPPORT)
/** @violates @ref Mcu_SCG_h_REF_3 Function-like macro defined.*/
#define  Call_Mcu_SCG_RestorePLLClockMonitorConfig(u32PLLClockMonitorConfig) \
do\
{ \
        Mcal_Trusted_Call1param(Mcu_SCG_RestorePLLClockMonitorConfig,(u32PLLClockMonitorConfig)); \
}\
while(0)
#else
/** @violates @ref Mcu_SCG_h_REF_3 Function-like macro defined.*/
