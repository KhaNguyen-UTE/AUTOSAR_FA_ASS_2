...
==================================================================================================*/
void LPIT0_Notification(void); //kien
/*==================================================================================================
*                                       LOCAL MACROS
==================================================================================================*/
...
static CONST(Gpt_ChannelConfigType, GPT_CONST) Gpt_InitChannelPB[1] =
{
    {   /*GptChannelConfiguration_0 configuration data*/
        ...
        &LPIT0_Notification, /* Channel notification */ //kien
        ...
        (Gpt_ChannelModeType)(GPT_CH_MODE_ONESHOT), /* Timer mode:continous/one-shot */
        {
            ...
            (uint32)((uint32)1U << LPIT_TCTRL_TRG_SRC_SHIFT),  /* LPIT Trigger Disabled */
#endif
#if (GPT_CHAIN_MODE == STD_ON)

            (boolean)(FALSE) /* Chain Mode Enable */
...
CONST(Gpt_ConfigType, GPT_CONST)  Gpt_Config =
{
    ...
    /*Hardware to logic channel mapping.*/
    {
        ...
        GptConf_GptChannelConfiguration_GptChannelConfiguration_0, /*mapping of LPIT_0_CH_0*/
