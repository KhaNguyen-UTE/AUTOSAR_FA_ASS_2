...
#define MCU_PBCFG_SW_PATCH_VERSION_C              4
...
/* Check if source file and Reg_eSys_PMC.h are from the same vendor */
#if (MCU_PBCFG_VENDOR_ID_C != REG_ESYS_PMC_VENDOR_ID)
    #error "Mcu_PBcfg.c and Reg_eSys_PMC.h have different vendor ids"
#endif
/* Check if source file and Reg_eSys_PMC.h are of the same Autosar version */
#if ((MCU_PBCFG_AR_RELEASE_MAJOR_VERSION_C != REG_ESYS_PMC_AR_RELEASE_MAJOR_VERSION) || \
     (MCU_PBCFG_AR_RELEASE_MINOR_VERSION_C != REG_ESYS_PMC_AR_RELEASE_MINOR_VERSION) || \
     (MCU_PBCFG_AR_RELEASE_REVISION_VERSION_C != REG_ESYS_PMC_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Mcu_PBcfg.c and Reg_eSys_PMC.h are different"
#endif
/*Check if source file and Reg_eSys_PMC.h are of the same Software version */
#if ((MCU_PBCFG_SW_MAJOR_VERSION_C != REG_ESYS_PMC_SW_MAJOR_VERSION) || \
     (MCU_PBCFG_SW_MINOR_VERSION_C != REG_ESYS_PMC_SW_MINOR_VERSION) || \
     (MCU_PBCFG_SW_PATCH_VERSION_C != REG_ESYS_PMC_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mcu_PBcfg.c and Reg_eSys_PMC.h are different"
#endif
...
*
*/
static CONST(Mcu_RamConfigType, MCU_CONST) Mcu_Ram_ConfigPB0[2] =
{

    {
        ...
        /* RAM default value. */
        (uint64) ( ((uint64)0x55U << 0U) | ((uint64)0x55U << 8U) | ((uint64)0x55U << 16U) | ((uint64)0x55U << 24U) ),
                ...
                
    {
        ...
        /* RAM default value. */
        (uint64) ( ((uint64)0xaaU << 0U) | ((uint64)0xaaU << 8U) | ((uint64)0xaaU << 16U) | ((uint64)0xaaU << 24U) ),
        /* RAM section write size (maximum allowed: 8). */
        (Mcu_RamWriteSizeType)4U
...
*/
static CONST( Mcu_ModeConfigType, MCU_CONST) Mcu_Mode_ConfigPB0[2] =
{
...
static CONST( Mcu_SCG_RegisterConfigType, MCU_CONST) SPLL_ClockConfigPB0_0[MCU_NUMBER_OF_SPLL_REGISTERS_U32] =
{
    /* SCG_SPLLCFG settings. */
    {
        ...
        (
            ...
            SCG_SPLLCFG_SOURCE_SOSC_U32 //kien
        )
    },
...
static CONST( Mcu_SCG_ClockConfigType, MCU_CONST) SCG_ClockConfigPB0_0 =
{
    ...
    (
        SCG_SCS_FIRC_U32 |
        SCG_DIVCORE_U32((uint32)2U) |
        SCG_DIVBUS_U32((uint32)2U) |
        SCG_DIVSLOW_U32((uint32)4U)
    ),
...
static CONST( Mcu_ClockConfigType, MCU_CONST) Mcu_ClockConfigPB0[1] =  
{
    ...
    /* Start of Mcu_ClockConfig[0]. */
    {
        ...
        (MCU_IPW_SOSC_UNDER_MCU_CONTROL |
         MCU_IPW_SIRC_NOT_UNDER_MCU_CONTROL |
         MCU_IPW_FIRC_NOT_UNDER_MCU_CONTROL |
