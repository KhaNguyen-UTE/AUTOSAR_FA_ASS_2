...
#define GPT_SW_PATCH_VERSION_CFG             4
...
/**
*   @brief   Enables or disables de-init module (only support for the platform that have the STM)
*            STD_ON: Enables de-init module (used for the platform that have STM)
*            STD_OFF: Disables de-init module (used for the platform without STM)
*
*/
#define GPT_STM_DEINIT_MODULE (STD_OFF)
