...
#define MCL_DMA_IRQ_SW_PATCH_VERSION_C                4
...
#if (MCL_DMA_IRQ_VENDOR_ID_C != MCL_IPW_VENDOR_ID)
    #error "Mcl_Dma_Irq.c and Mcl_IPW.h have different vendor ids"
#endif
/* Check if header file and Mcl_IPW.h header file are of the same Autosar version */
#if ((MCL_DMA_IRQ_AR_RELEASE_MAJOR_VERSION_C    != MCL_IPW_AR_RELEASE_MAJOR_VERSION) || \
     (MCL_DMA_IRQ_AR_RELEASE_MINOR_VERSION_C    != MCL_IPW_AR_RELEASE_MINOR_VERSION) || \
     (MCL_DMA_IRQ_AR_RELEASE_REVISION_VERSION_C != MCL_IPW_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Mcl_Dma_Irq.c and Mcl_IPW.h are different"
#endif
/* Check if header file and Mcl_IPW.h header file are of the same software version */
#if ((MCL_DMA_IRQ_SW_MAJOR_VERSION_C != MCL_IPW_SW_MAJOR_VERSION) || \
     (MCL_DMA_IRQ_SW_MINOR_VERSION_C != MCL_IPW_SW_MINOR_VERSION) || \
     (MCL_DMA_IRQ_SW_PATCH_VERSION_C != MCL_IPW_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mcl_Dma_Irq.c and Mcl_IPW.h are different"
#endif

#if (MCL_DMA_IRQ_VENDOR_ID_C != MCL_VENDOR_ID)
    #error "Mcl_Dma_Irq.c and Mcl_IPW.h have different vendor ids"
#endif
/* Check if header file and Mcl_IPW.h header file are of the same Autosar version */
#if ((MCL_DMA_IRQ_AR_RELEASE_MAJOR_VERSION_C    != MCL_AR_RELEASE_MAJOR_VERSION) || \
     (MCL_DMA_IRQ_AR_RELEASE_MINOR_VERSION_C    != MCL_AR_RELEASE_MINOR_VERSION) || \
     (MCL_DMA_IRQ_AR_RELEASE_REVISION_VERSION_C != MCL_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Mcl_Dma_Irq.c and Mcl_IPW.h are different"
#endif
/* Check if header file and Mcl_IPW.h header file are of the same software version */
#if ((MCL_DMA_IRQ_SW_MAJOR_VERSION_C != MCL_SW_MAJOR_VERSION) || \
     (MCL_DMA_IRQ_SW_MINOR_VERSION_C != MCL_SW_MINOR_VERSION) || \
     (MCL_DMA_IRQ_SW_PATCH_VERSION_C != MCL_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mcl_Dma_Irq.c and Mcl_IPW.h are different"
#endif

#if (MCL_DMA_IRQ_VENDOR_ID_C != MCL_VENDOR_ID_CFG)
    #error "Mcl_Dma_Irq.c and CDD_Mcl_Cfg.h have different vendor ids"
#endif
/* Check if header file and CDD_Mcl_Cfg.h header file are of the same Autosar version */
#if ((MCL_DMA_IRQ_AR_RELEASE_MAJOR_VERSION_C    != MCL_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (MCL_DMA_IRQ_AR_RELEASE_MINOR_VERSION_C    != MCL_AR_RELEASE_MINOR_VERSION_CFG) || \
     (MCL_DMA_IRQ_AR_RELEASE_REVISION_VERSION_C != MCL_AR_RELEASE_REVISION_VERSION_CFG) \
    )
    #error "AutoSar Version Numbers of Mcl_Dma_Irq.c and CDD_Mcl_Cfg.h are different"
#endif
/* Check if header file and CDD_Mcl_Cfg.h header file are of the same software version */
#if ((MCL_DMA_IRQ_SW_MAJOR_VERSION_C != MCL_SW_MAJOR_VERSION_CFG) || \
     (MCL_DMA_IRQ_SW_MINOR_VERSION_C != MCL_SW_MINOR_VERSION_CFG) || \
     (MCL_DMA_IRQ_SW_PATCH_VERSION_C != MCL_SW_PATCH_VERSION_CFG) \
    )
    #error "Software Version Numbers of Mcl_Dma_Irq.c and CDD_Mcl_Cfg.h are different"
#endif
/*==================================================================================================
...
#include "Mcl_MemMap.h"
    ...
    */
    ...
    )
    {
        ...
        VAR(Mcl_DmaChannelType, AUTOMATIC) RelChannel = (Mcl_DmaChannelType)0;
        /* @brief Variable storing the absolute channel */
        VAR(Mcl_DmaChannelType, AUTOMATIC) AbsChannel = (Mcl_DmaChannelType)0;
