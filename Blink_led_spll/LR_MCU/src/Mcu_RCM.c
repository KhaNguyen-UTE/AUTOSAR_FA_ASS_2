...
#define MCU_RCM_SW_PATCH_VERSION_C               4
...
*/
/**
* @violates @ref Mcu_RCM_c_REF_6 Violates MISRA 2004 Required Rule 8.10, global declaration of function
*/
