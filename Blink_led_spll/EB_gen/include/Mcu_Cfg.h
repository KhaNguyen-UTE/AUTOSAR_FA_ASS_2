...
#define MCU_CFG_SW_PATCH_VERSION                 4
...
#define MCU_SLEEPONEXIT_ID              ((uint8)0x19U)
/**@}*/
...
/**
* @brief            PMC: LVDSC1 register support
*/
#define MCU_PMC_LVDSC1_SUPPORT  (STD_ON)

/**
* @brief            PMC: LVRFLG register support
*/
#define MCU_PMC_LVRFLG_SUPPORT  (STD_OFF)
...
/* Support for errata e10777 */
#ifdef ERR_IPV_SCG_0001
#if (ERR_IPV_SCG_0001 == STD_ON)
/**
* @brief            This feature is used to support errata e10777.
*/
#define MCU_E10777_IPV_SCG_0001                           (STD_ON)
...
/**
* @brief           This define controls the availability of function Mcu_CM4_SleepOnExit
*/
#define MCU_SLEEPONEXIT_SUPPORT
...
#define McuRamSectorSettingConf_1   ((Mcu_RamSectionType)1U)
#define McuConf_McuRamSectorSettingConf_McuRamSectorSettingConf_1   ((Mcu_RamSectionType)1U)
