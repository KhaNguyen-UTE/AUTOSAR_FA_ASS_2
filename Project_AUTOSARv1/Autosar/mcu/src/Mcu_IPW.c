...
#define MCU_IPW_SW_PATCH_VERSION_C              4
...
/* Check if current file and Reg_eSys_CMU header file are of the same vendor */
#if (MCU_IPW_VENDOR_ID_C != REG_ESYS_CMU_VENDOR_ID)
    #error "Mcu_IPW.c and Reg_eSys_CMU.h have different vendor ids"
#endif
/* Check if current file and Reg_eSys_CMU header file are of the same Autosar version */
#if ((MCU_IPW_AR_RELEASE_MAJOR_VERSION_C    != REG_ESYS_CMU_AR_RELEASE_MAJOR_VERSION) || \
     (MCU_IPW_AR_RELEASE_MINOR_VERSION_C    != REG_ESYS_CMU_AR_RELEASE_MINOR_VERSION) || \
     (MCU_IPW_AR_RELEASE_REVISION_VERSION_C != REG_ESYS_CMU_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Mcu_IPW.c and Reg_eSys_CMU.h are different"
#endif
/* Check if current file and Reg_eSys_CMU header file are of the same Software version */
#if ((MCU_IPW_SW_MAJOR_VERSION_C != REG_ESYS_CMU_SW_MAJOR_VERSION) || \
     (MCU_IPW_SW_MINOR_VERSION_C != REG_ESYS_CMU_SW_MINOR_VERSION) || \
     (MCU_IPW_SW_PATCH_VERSION_C != REG_ESYS_CMU_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mcu_IPW.c and Reg_eSys_CMU.h are different"
#endif

/* Check if current file and Reg_eSys_PCC header file are of the same vendor */
#if (MCU_IPW_VENDOR_ID_C != REG_ESYS_PCC_VENDOR_ID)
    #error "Mcu_IPW.c and Reg_eSys_PCC.h have different vendor ids"
#endif
/* Check if current file and Reg_eSys_PCC header file are of the same Autosar version */
#if ((MCU_IPW_AR_RELEASE_MAJOR_VERSION_C    != REG_ESYS_PCC_AR_RELEASE_MAJOR_VERSION) || \
     (MCU_IPW_AR_RELEASE_MINOR_VERSION_C    != REG_ESYS_PCC_AR_RELEASE_MINOR_VERSION) || \
     (MCU_IPW_AR_RELEASE_REVISION_VERSION_C != REG_ESYS_PCC_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Mcu_IPW.c and Reg_eSys_PCC.h are different"
#endif
/* Check if current file and Reg_eSys_PCC header file are of the same Software version */
#if ((MCU_IPW_SW_MAJOR_VERSION_C != REG_ESYS_PCC_SW_MAJOR_VERSION) || \
     (MCU_IPW_SW_MINOR_VERSION_C != REG_ESYS_PCC_SW_MINOR_VERSION) || \
     (MCU_IPW_SW_PATCH_VERSION_C != REG_ESYS_PCC_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mcu_IPW.c and Reg_eSys_PCC.h are different"
#endif

/* Check if current file and Reg_eSys_SCG header file are of the same vendor */
#if (MCU_IPW_VENDOR_ID_C != REG_ESYS_SCG_VENDOR_ID)
    #error "Mcu_IPW.c and Reg_eSys_SCG.h have different vendor ids"
#endif
/* Check if current file and Reg_eSys_SCG header file are of the same Autosar version */
#if ((MCU_IPW_AR_RELEASE_MAJOR_VERSION_C    != REG_ESYS_SCG_AR_RELEASE_MAJOR_VERSION) || \
     (MCU_IPW_AR_RELEASE_MINOR_VERSION_C    != REG_ESYS_SCG_AR_RELEASE_MINOR_VERSION) || \
     (MCU_IPW_AR_RELEASE_REVISION_VERSION_C != REG_ESYS_SCG_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Mcu_IPW.c and Reg_eSys_SCG.h are different"
#endif
/* Check if current file and Reg_eSys_SCG header file are of the same Software version */
#if ((MCU_IPW_SW_MAJOR_VERSION_C != REG_ESYS_SCG_SW_MAJOR_VERSION) || \
     (MCU_IPW_SW_MINOR_VERSION_C != REG_ESYS_SCG_SW_MINOR_VERSION) || \
     (MCU_IPW_SW_PATCH_VERSION_C != REG_ESYS_SCG_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mcu_IPW.c and Reg_eSys_SCG.h are different"
#endif

/* Check if current file and Mcu_CortexM4 header file are of the same vendor */
#if (MCU_IPW_VENDOR_ID_C != MCU_CORTEXM4_VENDOR_ID)
    #error "Mcu_IPW.c and Mcu_CortexM4.h have different vendor ids"
#endif
/* Check if current file and Mcu_CortexM4 header file are of the same Autosar version */
#if ((MCU_IPW_AR_RELEASE_MAJOR_VERSION_C    != MCU_CORTEXM4_AR_RELEASE_MAJOR_VERSION) || \
     (MCU_IPW_AR_RELEASE_MINOR_VERSION_C    != MCU_CORTEXM4_AR_RELEASE_MINOR_VERSION) || \
     (MCU_IPW_AR_RELEASE_REVISION_VERSION_C != MCU_CORTEXM4_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Mcu_IPW.c and Mcu_CortexM4.h are different"
#endif
/* Check if current file and Mcu_CortexM4 header file are of the same Software version */
#if ((MCU_IPW_SW_MAJOR_VERSION_C != MCU_CORTEXM4_SW_MAJOR_VERSION) || \
     (MCU_IPW_SW_MINOR_VERSION_C != MCU_CORTEXM4_SW_MINOR_VERSION) || \
     (MCU_IPW_SW_PATCH_VERSION_C != MCU_CORTEXM4_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mcu_IPW.c and Mcu_CortexM4.h are different"
#endif
...
static FUNC( void, MCU_CODE) Mcu_Ipw_DisableSpllClock(VAR( void, AUTOMATIC));
#endif  /* MCU_NO_PLL */
#endif
...
#if (MCU_NO_PLL == STD_OFF)
/**
* @brief            This function will disable SPLL clock
*/
...
#if ( (MCU_DISABLE_SMC_INIT != STD_OFF) && \
      (MCU_DISABLE_PMC_INIT != STD_OFF) && \
      (MCU_DISABLE_RCM_INIT != STD_OFF) && \
      (MCU_DISABLE_SIM_INIT != STD_OFF) \
    )
...
FUNC( void, MCU_CODE) Mcu_Ipw_DistributePllClock( VAR( void, AUTOMATIC) )
{
    ...
    if ( NULL_PTR != Mcu_pClockConfig)
    {
        ...
        if (SCG_SYS_CLK_NOT_UNDER_MCU_CONTROL != Mcu_pClockConfig->SCG_pClockConfig->u32RunClockControlConfiguration)
        {
            ...
            Call_Mcu_SCG_ActivePllClock(); //created by HaoTV13
...
#endif
        #if (MCU_NO_PLL == STD_OFF)
        /* When entering VLPS/VLPR mode, the PLL must be disabled before making any mode transition. */
        Mcu_Ipw_DisableSpllClock();
        #endif /* (MCU_NO_PLL == STD_OFF) */
...
*
*/
FUNC( void, MCU_CODE) Mcu_Ipw_CM4_SleepOnExit(VAR(Mcu_SleepOnExitType, AUTOMATIC) SleepOnExit)
{
    if (MCU_SLEEP_ON_EXIT_DISABLED == (Mcu_SleepOnExitType)SleepOnExit)
    {
        /** @violates @ref Mcu_IPW_c_REF_5 The comma operator shall not be used. */
        /**  @violates @ref Mcu_IPW_c_REF_7 MISRA 2004 Rule 16.9, function identifier */
        Call_Mcu_CM4_DisableSleepOnExit();
    }
    else
    {
        /** @violates @ref Mcu_IPW_c_REF_5 The comma operator shall not be used. */
        /**  @violates @ref Mcu_IPW_c_REF_7 MISRA 2004 Rule 16.9, function identifier */
        Call_Mcu_CM4_EnableSleepOnExit();
    }
}
#endif
